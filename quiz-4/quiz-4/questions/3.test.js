const getUserNameAndVehicleAge = require("./3");
...
describe(`question 3. getUserNameAndVehicleAge`, () => {
  test(`is a promise`, () => {
    const result = getUserNameAndVehicleAge(data);
    expect(result instanceof Promise).toBeTruthy();
  });

  test(`should return data`, async () => {
    const expected = [
      { userName: "Lucius11", totalAge: 183 },
      { userName: "Nicolas.Mayer48", totalAge: 23 },
      { userName: "Demetris_Weissnat77", totalAge: 3 },
    ];
    const result = await getUserNameAndVehicleAge(data);
