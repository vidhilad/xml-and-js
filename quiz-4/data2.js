...
console.log("-----------------------------------------------------");
const activeAccounts=passengers.filter((accounts)=> {
  return accounts.isActive=true
});
...
const highestBalance=passengers.reduce((currentVal,previousVal)=>{
...
const friendsName=passengers.map((accounts)=>{
...
const accountHoldersName=passengers.map((accounts)=>{
